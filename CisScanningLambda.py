    ...
    while True:
        try:
            ...
            if status == 'Success':
                ...
                if not x:
                    annotation = "The ec2 instance " + instanceId +" is NOT compliant"
                    compliance_type = 'NON_COMPLIANT'
                else:
                    annotation = "The ec2 instance " + instanceId +" is compliant"
                ...
                annotation = "cis-dil-benchmark scan was not successful. Ec2 instance " + instanceId + "'s state could not be determined.  Marked NON_COMPLIANT for now."
                compliance_type = 'NON_COMPLIANT'
            break
...
def lambda_handler(event, context):
    ...
    elif configuration_item['configuration']['instanceId'] == None:
        print("DEBUG: instandId missing")
        evaluation = {
